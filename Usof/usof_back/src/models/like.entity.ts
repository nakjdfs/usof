...
export type LikeCreationAttributes = Optional<ILike, "id">;

export class Like extends Model<ILike, LikeCreationAttributes> {
    declare ILike;
}
